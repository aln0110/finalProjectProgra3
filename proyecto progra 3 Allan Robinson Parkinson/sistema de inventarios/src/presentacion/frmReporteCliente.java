...
public class frmReporteCliente extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        dtRegistros.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Articulo", "Vendedor", "Cliente", "Cantidad", "Descuento", "SubTotal", "Total"
            }
        ));
...
try {       
          //  String variable;
            ...
            // este metodo lo que hace es llamar los datos de la base de datos where cedCliente =? y posteriormente se los pasa al dataTable
            List<venta> miLista = logVenta.ventaPorCliente(txtCedula.getText());
            ...
            for (int i = 0; i < miLista.size(); i++) {
              ...
              //  if (miLista.get(i).getCedCliente().equals(txtCedula.getText())) {
